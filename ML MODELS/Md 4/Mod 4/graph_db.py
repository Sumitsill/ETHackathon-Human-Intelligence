...
class GraphDBWrapper:
    def __init__(self):
        ...
        try:
            print(f"Mod 4: Connecting to Neo4j at {self.uri}...")
            self.driver = GraphDatabase.driver(self.uri, auth=(self.user, self.password))
            self.driver.verify_connectivity()
            print("Mod 4: Neo4j connection verified successfully.")
        except Exception as e:
            print(f"Mod 4: Neo4j connection failed: {e}. Activating mock graph storage: {self.mock_file_path}")
            self.use_mock = True
    ...
    def _read_mock_graph(self) -> dict:
        try:
            ...
            print(f"Mod 4: Failed reading mock graph file: {e}")
    ...
    def _save_mock_graph(self, data: dict):
        try:
            ...
            print(f"Mod 4: Failed saving mock graph file: {e}")
    ...
    def upsert_node(self, label: str, key_prop: str, key_val: str, properties: dict):
        ...
        try:
            ...
            print(f"Mod 4: Neo4j upsert_node failed: {e}. Switching to mock.")
            self.use_mock = True
    ...
    def upsert_relationship(self, from_label: str, from_key: str, from_val: str,
        ...
        try:
            ...
            print(f"Mod 4: Neo4j upsert_relationship failed: {e}. Switching to mock.")
            self.use_mock = True
    ...
    def get_all_data(self) -> dict:
        ...
        try:
            ...
            print(f"Mod 4: Querying Neo4j failed: {e}. Returning mock fallback.")
            return self._read_mock_graph()
    ...
    def get_connected_nodes(self, node_label: str, key_prop: str, key_val: str) -> dict:
        ...
        for n in graph["nodes"]:
            # Check key_prop and fallback properties
            prop_val = n["properties"].get(key_prop) or n["properties"].get("tag") or n["properties"].get("id") or n["properties"].get("name")
            if n["label"] == node_label and prop_val == key_val:
